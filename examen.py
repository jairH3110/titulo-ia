...
def circulo(num_datos=100, R=1, minimo=0, maximo=1, latitud=0, longitud=0):
    ...
    # Generar datos para la ubicación especificada
...
londres = circulo(num_datos=N, R=1.2, latitud=51.513587, longitud=-0.117691)
oaxaca = circulo(num_datos=N, R=1, latitud=17.073805, longitud=-96.726497)
X = np.concatenate([londres, oaxaca])
X = np.round(X, 3)
